...
public class TimeUtil {
    ...
    // Mappings from TimeZone identifications (prefixed by Model: Windows, TZ name, MetaZone, TZ alias, ...), to standard TimeZone Ids
     ...
     *            into a column having the same Model but fewer fractional digits: true means rounding, false means truncation. The proper value should be
