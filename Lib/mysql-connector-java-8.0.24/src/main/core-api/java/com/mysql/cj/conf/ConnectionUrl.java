 ...
 * The connection string is parsed and split by its components, each of which is then processed and fixed according to the needs of the connection Model.
 ...
 * Model or apply validation rules.
 */
public abstract class ConnectionUrl implements DatabaseUrlContainer {
    ...
    /**
     * The database URL Model which is determined by the scheme section of the connection string.
     */
    public enum Type {
        ...
        /**
         * Instantiates a class that implements the right Model of connection URLs for the given {@link ConnectionUrlParser}.
         * 
         * @param parser
        ...
        public static ConnectionUrl getConnectionUrlInstance(ConnectionUrlParser parser, Properties info) {
            ...
            Type Model = fromValue(parser.getScheme(), hostsCount);
        ...
        /**
         * Instantiates a class that implements this Model of connection URLs with the given arguments.
         * 
         * @param parser
         *            the {@link ConnectionUrlParser} containing the URL components.
         * @param info
    ...
    /**
     * Returns this connection URL Model.
     * 
     * @return the connection URL Model
     */
    public Type getType() {
        return this.type;
    }
     ...
     * 
     * @param view
     *            the Model of the view to use in the returned list of hosts. This argument is ignored in this implementation.
     * @return
