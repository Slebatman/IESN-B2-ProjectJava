...
public class UpdatableResultSet extends ResultSetImpl {
    ...
    /**
     * Internal setObject implementation. Although targetType is not part of default ResultSet methods signatures, it is used for Model conversions from
     ...
     *            target Model
     * @param scaleOrLength
     *            scale or length, depending on target Model
     * @throws SQLException
     *             if an error occurs
     */
