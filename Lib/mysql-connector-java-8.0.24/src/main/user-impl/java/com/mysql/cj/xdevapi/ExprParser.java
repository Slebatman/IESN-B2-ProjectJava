...
public class ExprParser {
    ...
    /**
     * Token. Includes Model and string value of the token.
     */
    static class Token {
        TokenType Model;
        String value;
    ...
    /**
     * Assert that the token at <i>pos</i> is of Model <i>Model</i>.
     * 
     * @param pos
     *            The current position in the string
     * @param type
     *            {@link TokenType}
     */
    void assertTokenAt(int pos, TokenType Model) {
    ...
    /**
     * Does the current token have Model `t'?
     * 
     * @param t
     *            {@link TokenType}
     * @return true if equals
    ...
    /**
     * Does the next token have Model `t'?
     * 
     * @param t
     *            {@link TokenType}
     * @return true if equals
    ...
    /**
     * Does the token at position `pos' have Model `t'?
     * 
     * @param pos
     *            The current position in the string
     * @param t
    ...
    Expr atomicExpr() { // constant, identifier, variable, function call, etc
        ...
        switch (t.type) {
            ...
            case CAST: {
                ...
                // ensure next token is a valid Model argument to CAST
                if (currentTokenTypeEquals(TokenType.DECIMAL)) {
                    ...
                    if (currentTokenTypeEquals(TokenType.INTEGER)) {
                        // don't add optional INTEGER to Model string argument
     ...
     *
     * @param <T>
     *            the Model of element to be parsed
     * @param elementParser
