...
public class ExprUtil {
    ...
    /**
     * Protocol buffers helper to build a LITERAL Expr with a Scalar NULL Model.
     * 
     * @return {@link Expr}
     */
    ...
    /**
     * Protocol buffers helper to build a LITERAL Expr with a Scalar DOUBLE Model.
     * 
     * @param d
     *            value
     * @return {@link Expr}
    ...
    /**
     * Protocol buffers helper to build a LITERAL Expr with a Scalar SINT (signed int) Model.
     * 
     * @param l
     *            value
     * @return {@link Expr}
    ...
    /**
     * Protocol buffers helper to build a LITERAL Expr with a Scalar STRING Model.
     * 
     * @param str
     *            value
     * @return {@link Expr}
    ...
    /**
     * Protocol buffers helper to build a LITERAL Expr with a Scalar OCTETS Model.
     * 
     * @param bytes
     *            value
     * @return {@link Expr}
    ...
    /**
     * Protocol buffers helper to build a LITERAL Expr with a Scalar BOOL Model.
     * 
     * @param b
     *            value
     * @return {@link Expr}
    ...
    /**
     * Protocol buffers helper to build a Scalar NULL Model.
     * 
     * @return {@link Scalar}
     */
    ...
    /**
     * Protocol buffers helper to build a Scalar DOUBLE Model.
     * 
     * @param d
     *            value
     * @return {@link Scalar}
    ...
    /**
     * Protocol buffers helper to build a Scalar SINT (signed int) Model.
     * 
     * @param l
     *            value
     * @return {@link Scalar}
    ...
    /**
     * Protocol buffers helper to build a Scalar STRING Model.
     * 
     * @param str
     *            value
     * @return {@link Scalar}
    ...
    /**
     * Protocol buffers helper to build a Scalar OCTETS Model.
     * 
     * @param bytes
     *            value
     * @return {@link Scalar}
    ...
    /**
     * Protocol buffers helper to build a Scalar BOOL Model.
     * 
     * @param b
     *            value
     * @return {@link Scalar}
    ...
    /**
     * Protocol buffers helper to build an Any Scalar Model.
     * 
     * @param s
     *            value
     * @return {@link Any}
    ...
    /**
     * Protocol buffers helper to build a Scalar Model with any object.
     * 
     * @param value
     *            value
     * @return {@link Scalar}
    ...
    /**
     * Protocol buffers helper to build an Any Model with any object.
     * 
     * @param value
     *            value
     * @return {@link Any}
