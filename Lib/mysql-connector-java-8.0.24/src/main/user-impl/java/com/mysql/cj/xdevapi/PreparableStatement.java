...
public abstract class PreparableStatement<RES_T> {
    ...
    /**
     * Executes the statement directly (non-prepared). Implementation is dependent on the statement Model.
     * 
     * @return
    ...
    /**
     * Returns the {@link XMessage} needed to prepare this statement. Implementation is dependent on the statement Model.
     * 
     * @return
    ...
    /**
     * Executes a previously server-prepared statement. Implementation is dependent on the statement Model.
     * 
     * @return
     *         the object returned from the lower level statement execution
     */
