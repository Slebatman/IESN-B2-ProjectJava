...
public class MetadataTest extends BaseTableTestCase {
    ...
    /**
     * Some metadata fields have no sense with concrete SQL data Model. The following table from {@link ColumnMetaData}
     * describes which fields are relevant to each Model:
     * 
     * <pre>
     *     ================= ============ ======= ========== ====== ========
     *     SQL Type          .Model        .length .frac_dig  .flags .charset
     *     ================= ============ ======= ========== ====== ========
     *     TINY              SINT         x
