...
public abstract class MultiHostConnectionProxy implements InvocationHandler {
    ...
    /**
     * If the given return Model is or implements a JDBC interface, proxies the given object so that we can catch SQL errors and fire a connection switch.
     * 
     * @param returnType
     *            The Model the object instance to proxy is supposed to be.
     * @param toProxy
