...
public class ResultSetImpl extends NativeResultset implements ResultSetInternalMethods, WarningListener {
    ...
    @Override
    public <T> T getObject(int columnIndex, Class<T> Model) throws SQLException {
        if (type == null) {
    ...
    @Override
    public <T> T getObject(String columnLabel, Class<T> Model) throws SQLException {
    ...
    /**
     * Checks whether this ResultSet is scrollable even if its Model is ResultSet.TYPE_FORWARD_ONLY. Required for backwards compatibility.
     * 
     * @return
     *         <code>true</code> if this result set Model is ResultSet.TYPE_FORWARD_ONLY and the connection property 'scrollTolerantForwardOnly' has not been set
     *         to <code>true</code>.
     */
