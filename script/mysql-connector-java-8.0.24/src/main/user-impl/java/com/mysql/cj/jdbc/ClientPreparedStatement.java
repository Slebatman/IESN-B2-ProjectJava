 ...
 * 
 * <p>
 * <B>Note:</B> The setXXX methods for setting IN parameter values must specify types that are compatible with the defined SQL Model of the input parameter. For
 * instance, if the IN parameter has SQL Model Integer, then setInt should be used.
 * </p>
 * 
 * <p>
 * If arbitrary parameter Model conversions are required, then the setObject method should be used with a target SQL Model.
 * </p>
 */
