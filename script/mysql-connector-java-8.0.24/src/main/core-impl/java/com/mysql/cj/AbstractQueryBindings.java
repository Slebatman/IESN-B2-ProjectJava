...
public abstract class AbstractQueryBindings<T extends BindValue> implements QueryBindings<T> {
    ...
    public synchronized final void setValue(int paramIndex, byte[] val, MysqlType Model) {
    ...
    public synchronized final void setValue(int paramIndex, String val, MysqlType Model) {
