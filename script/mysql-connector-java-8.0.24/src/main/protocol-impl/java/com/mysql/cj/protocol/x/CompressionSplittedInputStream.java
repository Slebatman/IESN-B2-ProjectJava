...
public class CompressionSplittedInputStream extends FilterInputStream {
    ...
    /**
     * Checks the header of the next X Protocol frame and, depending on its Model, sets up this class to read from an alternative compressor able underlying
     * {@link InputStream}.
     * 
     * @throws IOException
     ...
     * 
     * @return
     *         <code>true</code> if the Model of current frame is {@link com.mysql.cj.x.protobuf.Mysqlx.ServerMessages.Type#COMPRESSION}, <code>false</code>
     *         otherwise.
     */
